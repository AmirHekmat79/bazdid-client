        ...
        <v-card elavation="8" class="card-container h-auto">
          ...
          <v-card-actions class="mt-4 mr-auto card-actions-container">
            <SecondaryButton
              ...
              class="text-black bg-info modal-btn mr-auto"
            >
              افزودن عکس
            </SecondaryButton>
            <img
      ...
      items: [
        {
          ...
          title: "جلو و پلاک",
          imageUrl: null,
          imageBaseUrl: "../../public/images/frontSide.jpg",
        },
        {
          id: 2,
          title: "عقب و پلاک",
          imageUrl: null,
          imageBaseUrl: "../../public/images/backSide.webp",
        },
        {
          id: 3,
          title: "جلو و راست",
          imageUrl: null,
          imageBaseUrl: "../../public/images/rightSide.jpg",
        },
      ],
      file: null,
      imageUrl: null,
  ...
  methods: {
    ...
    triggerFileInput(index) {
      ...
      if (fileInput) {
        ...
        this.$refs.previewImgElement[index].src == this.items[index].imageUrl
      ) {
        this.$refs.previewImgElement[index].src =
          "../../public/images/Page-1.png";
      } else {
